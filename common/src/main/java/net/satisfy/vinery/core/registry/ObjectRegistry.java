...
import net.satisfy.vinery.core.world.VineryTreeGrower;
...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Block> DARK_CHERRY_SIGN = registerWithoutItem("dark_cherry_sign", () -> new ModStandingSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN), VineryWoodType.DARK_CHERRY));
    public static final RegistrySupplier<Block> DARK_CHERRY_WALL_SIGN = registerWithoutItem("dark_cherry_wall_sign", () -> new ModWallSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN), VineryWoodType.DARK_CHERRY));
    public static final RegistrySupplier<Block> DARK_CHERRY_HANGING_SIGN = registerWithoutItem("dark_cherry_hanging_sign", () -> new ModHangingSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_HANGING_SIGN), VineryWoodType.DARK_CHERRY));
    public static final RegistrySupplier<Block> DARK_CHERRY_WALL_HANGING_SIGN = registerWithoutItem("dark_cherry_wall_hanging_sign", () -> new ModWallHangingSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_HANGING_SIGN), VineryWoodType.DARK_CHERRY));
    ...
    public static final RegistrySupplier<Block> DARK_CHERRY_SAPLING = registerWithItem("dark_cherry_sapling", () -> new SaplingBlock(new VineryTreeGrower("dark_cherry", VineryConfiguredFeatures.DARK_CHERRY_KEY, VineryConfiguredFeatures.DARK_CHERRY_VARIANT_KEY), BlockBehaviour.Properties.of().noCollission().randomTicks().instabreak().sound(SoundType.GRASS)));
    public static final RegistrySupplier<Block> APPLE_TREE_SAPLING = registerWithItem("apple_tree_sapling", () -> new SaplingBlock(new VineryTreeGrower("apple_tree", VineryConfiguredFeatures.APPLE_KEY, VineryConfiguredFeatures.APPLE_VARIANT_KEY), BlockBehaviour.Properties.of().noCollission().randomTicks().instabreak().sound(SoundType.GRASS)));
    ...
    public static final RegistrySupplier<Block> DARK_CHERRY_LEAVES = registerWithItem("dark_cherry_leaves", () -> new CherryLeavesBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES)));
    ...
    public static final RegistrySupplier<Block> DARK_CHERRY_BARREL = registerWithItem("dark_cherry_barrel", () -> new BarrelBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BARREL)));
    ...
    public static final RegistrySupplier<Block> STORAGE_POT = registerWithItem("storage_pot", () -> new StoragePotBlock(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(SoundType.WOOD), SoundEvents.BRUSH_GENERIC, SoundEvents.BRUSH_GENERIC));
    ...
    public static final RegistrySupplier<Block> SPRUCE_LATTICE = registerWithItem("spruce_lattice", () -> new LatticeBlock(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(Blocks.SPRUCE_PLANKS.defaultBlockState().getSoundType()).noOcclusion()));
    public static final RegistrySupplier<Block> CHERRY_LATTICE = registerWithItem("cherry_lattice", () -> new LatticeBlock(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(Blocks.CHERRY_PLANKS.defaultBlockState().getSoundType()).noOcclusion()));
    public static final RegistrySupplier<Block> BIRCH_LATTICE = registerWithItem("birch_lattice", () -> new LatticeBlock(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(Blocks.BIRCH_PLANKS.defaultBlockState().getSoundType()).noOcclusion()));
    public static final RegistrySupplier<Block> DARK_OAK_LATTICE = registerWithItem("dark_oak_lattice", () -> new LatticeBlock(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(Blocks.DARK_OAK_PLANKS.defaultBlockState().getSoundType()).noOcclusion()));
    public static final RegistrySupplier<Block> ACACIA_LATTICE = registerWithItem("acacia_lattice", () -> new LatticeBlock(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(Blocks.ACACIA_PLANKS.defaultBlockState().getSoundType()).noOcclusion()));
    public static final RegistrySupplier<Block> BAMBOO_LATTICE = registerWithItem("bamboo_lattice", () -> new LatticeBlock(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(Blocks.BAMBOO_PLANKS.defaultBlockState().getSoundType()).noOcclusion()));
    public static final RegistrySupplier<Block> JUNGLE_LATTICE = registerWithItem("jungle_lattice", () -> new LatticeBlock(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(Blocks.JUNGLE_PLANKS.defaultBlockState().getSoundType()).noOcclusion()));
    public static final RegistrySupplier<Block> MANGROVE_LATTICE = registerWithItem("mangrove_lattice", () -> new LatticeBlock(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(Blocks.MANGROVE_PLANKS.defaultBlockState().getSoundType()).noOcclusion()));
    public static final RegistrySupplier<Block> DARK_CHERRY_LATTICE = registerWithItem("dark_cherry_lattice", () -> new LatticeBlock(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(Blocks.MANGROVE_PLANKS.defaultBlockState().getSoundType()).noOcclusion()));
    ...
    public static final RegistrySupplier<Item> KELP_CIDER_ITEM = registerWineItem("kelp_cider", KELP_CIDER, () -> createWineSettings(MobEffectRegistry.WATER_WALKER, 1600, 0), true);
    public static final RegistrySupplier<Item> EISWEIN_ITEM = registerWineItem("eiswein", EISWEIN, () -> createWineSettings(MobEffectRegistry.FROSTY_ARMOR_EFFECT, 1600, 0), true);
    public static final RegistrySupplier<Item> AEGIS_WINE_ITEM = registerWineItem("aegis_wine", AEGIS_WINE, () -> createWineSettings(MobEffectRegistry.ARMOR_EFFECT, 1600, 0), true);
    ...
    public static final RegistrySupplier<Item> CLARK_WINE_ITEM = registerWineItem("clark_wine", CLARK_WINE, () -> createWineSettings(MobEffectRegistry.IMPROVED_JUMP_BOOST, 1600, 0), true);
    public static final RegistrySupplier<Item> JELLIE_WINE_ITEM = registerWineItem("jellie_wine", JELLIE_WINE, () -> createWineSettings(MobEffectRegistry.JELLIE, 1600, 0), true);
    public static final RegistrySupplier<Item> NOIR_WINE_ITEM = registerWineItem("noir_wine", NOIR_WINE, () -> createWineSettings(MobEffects.JUMP, 1600, 0), true);
    public static final RegistrySupplier<Item> RED_WINE_ITEM = registerWineItem("red_wine", RED_WINE, () -> createWineSettings(MobEffects.SLOW_FALLING, 1600, 0), true);
    public static final RegistrySupplier<Item> STRAD_WINE_ITEM = registerWineItem("strad_wine", STRAD_WINE, () -> createWineSettings(MobEffects.NIGHT_VISION, 1600, 0), true);
    public static final RegistrySupplier<Item> CHERRY_WINE_ITEM = registerWineItem("cherry_wine", CHERRY_WINE, () -> createWineSettings(MobEffects.INVISIBILITY, 1600, 0), true);
    public static final RegistrySupplier<Item> CRISTEL_WINE_ITEM = registerWineItem("cristel_wine", CRISTEL_WINE, () -> createWineSettings(MobEffects.WATER_BREATHING, 1600, 0), true);
    public static final RegistrySupplier<Item> LILITU_WINE_ITEM = registerWineItem("lilitu_wine", LILITU_WINE, () -> createWineSettings(MobEffectRegistry.PARTY_EFFECT, 1600, 0), true);
    public static final RegistrySupplier<Item> JO_SPECIAL_MIXTURE_ITEM = registerWineItem("jo_special_mixture", JO_SPECIAL_MIXTURE, () -> createWineSettings(MobEffectRegistry.CLIMBING_EFFECT, 1600, 0), true);
    public static final RegistrySupplier<Item> BOLVAR_WINE_ITEM = registerWineItem("bolvar_wine", BOLVAR_WINE, () -> createWineSettings(MobEffectRegistry.LAVA_WALKER, 1600, 0), true);
    public static final RegistrySupplier<Item> MAGNETIC_WINE_ITEM = registerWineItem("magnetic_wine", MAGNETIC_WINE, () -> createWineSettings(MobEffectRegistry.MAGNET, 1600, 0), true);
    public static final RegistrySupplier<Item> STAL_WINE_ITEM = registerWineItem("stal_wine", STAL_WINE, () -> createWineSettings(MobEffectRegistry.HEALTH_EFFECT, 1600, 0), true);
    public static final RegistrySupplier<Item> CHENET_WINE_ITEM = registerWineItem("chenet_wine", CHENET_WINE, () -> createWineSettings(MobEffectRegistry.CLIMBING_EFFECT, 1600, 0), true);
    public static final RegistrySupplier<Item> BOTTLE_MOJANG_NOIR_ITEM = registerWineItem("bottle_mojang_noir", BOTTLE_MOJANG_NOIR, () -> createWineSettings(MobEffectRegistry.EXPERIENCE_EFFECT, 1600, 0), true);
    public static final RegistrySupplier<Item> CHORUS_WINE_ITEM = registerFixedDurationWineItem("chorus_wine", CHORUS_WINE, 10, MobEffectRegistry.TELEPORT, 0);
    public static final RegistrySupplier<Item> CREEPERS_CRUSH_ITEM = registerFixedDurationWineItem("creepers_crush", CREEPERS_CRUSH, 100, MobEffectRegistry.CREEPER_EFFECT, 0);
    ...
    private static RegistrySupplier<Item> registerFixedDurationWineItem(
            ...
            Holder<MobEffect> effectSupplier,
            int amplifier
    ) {
        return registerItem(name, () -> {
            FoodProperties food = new FoodProperties.Builder()
                    .effect(new MobEffectInstance(effectSupplier, fixedDurationTicks, amplifier), 1.0f)
